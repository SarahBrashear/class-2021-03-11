...
What percentage of 435 districts did Biden win?
...
posterior_epred(fit_1, 
  ...
  ggplot(aes(x = `1`)) +
    ...
    labs(title = "Posterior Probability Distribution",
         subtitle = "",
         x = "Percent of Districts Biden Wins",
         y = "Probability") + 
...
posterior_predict(fit_1, 
  ...
  ggplot(aes(total)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),
                   bins = 50) +
    labs(title = "Posterior Probability Distribution",
         subtitle = "Number of Biden Wins in 10 Random Districts",
         x = "Number of Districts Biden Won",
         y = "Probability") + 
